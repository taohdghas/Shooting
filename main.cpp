...
Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> CreateDescriptorHeap(
	Microsoft::WRL::ComPtr<ID3D12Device> device, D3D12_DESCRIPTOR_HEAP_TYPE heapType, UINT numDescriptors, bool shaderVisivle) {
...
#pragma endregion
	...
	*/
	/*
	// 初期値0でFenceを作る
	Microsoft::WRL::ComPtr<ID3D12Fence> e= nullptr;
...
#pragma region メインループ
	...
	while (true) {
		...
		*/
		...
		Matrix4x4 projectionMatrixSprite = MakeOrthographicMatrix(0.0f, 0.0f, float(windowsAPI->kClientWitdh), float(windowsAPI->kClientHeight), 0.0f, 100.0f);
