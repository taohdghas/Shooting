...
void GameScene::Initialize() {
	...
	//ボス1生成・初期化
	for (auto& bossData : level_data_->bosses) {
		boss1_ = std::make_unique<Boss1>();
		boss1_->Initialize(MyEngine::Object3dBase::GetInstance());
		boss1_->SetTranslate(bossData.translation);
	}
