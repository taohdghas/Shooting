...
public:
	...
	/// </summary>
	/// <param name="windowsAPI">Win32 ウィンドウ情報を提供する WindowsAPI*</param>
	/// <param name="directxBase">DirectX リソースを管理する DirectXBase*</param>
	/// <param name="srvmanager">SRV の割り当ておよびデスクリプタ情報を提供する SrvManager*</param>
